...
import com.example.mangareader.model.data.DatabaseSqlite;
import com.example.mangareader.model.data.InputValidation;
import com.example.mangareader.model.data.Users;
...
public class RegistrationActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initObjects() {
        ...
        databaseHelper = new DatabaseSqlite(activity);
        user = new Users();
